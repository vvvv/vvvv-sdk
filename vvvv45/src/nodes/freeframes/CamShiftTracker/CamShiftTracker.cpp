...
DWORD initialise()
{
    ...
    GParamConstants[9].Type   = 20;
    GParamConstants[10].Type  = 20;
    ...
    char tempName7[17]  = "Area Threshold";
...
plugClass::plugClass()
{
    ...
    sc_reinit = sc_filtersize = sc_areathresh = 0;
         ...
         if(first_round)
           {
            ...
            cvCalcHist( &Ghue, hist[obj], 0, Gmask );
            cvGetMinMaxHistValue( hist[obj], 0, &max_val, 0, 0 );
