...
namespace VVVV.Hosting.Pins
{
    ...
    /// </summary>
    [ComVisible(false)]
    public abstract class DiffSpreadList<T> : Spread<ISpread<T>>, IDiffSpread<ISpread<T>>, IDisposable
    {
        ...
        public DiffSpreadList(IOFactory ioFactory, IOAttribute attribute)
            : base(0)
        {
            //store fields
