...
{
	static class PinUtils
	{
		public static void LoadDefaultValues(Type type, PinAttribute attribute, out int dimension, out double minValue, out double maxValue, out double stepSize, out bool isInteger)
		{
			dimension = 1;
