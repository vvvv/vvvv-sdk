...
namespace VVVV.PluginInterfaces.V1
{
    ...
    public static class NodeInTypoFix
    {
        [Obsolete]
        public static void GetUpsreamSlice(this INodeIn n, int slice, out int upstreamSlice)
            => n.GetUpstreamSlice(slice, out upstreamSlice);
    }
	...
	unsafe public interface INodeIn: IPluginIn
	{
		...
		void GetUpstreamSlice(int slice, out int upstreamSlice);
		/// <summary>
