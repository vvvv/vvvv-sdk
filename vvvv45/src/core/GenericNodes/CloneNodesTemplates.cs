...
namespace VVVV.Nodes
{
    ...
    //3.) remove the comments from the PluginInfo attributes

    //4.) you have to override the CloneSlice or the CloneSpread method for your type. overriding CloneSlice is easier, CloneSpread might allow some performance optimizations
