...
{
    [PluginInfo(Name = "World", Category = "Kinect", Version = "Microsoft", Author = "vux", Tags = "directx,texture")]
        ...
        public void UpdateResource(IPluginOut ForPin, Device OnDevice)
        {
            if (this.runtime != null)
            {
                ...
                if (!this.FDepthTex.ContainsKey(OnDevice))
                {
                    ...
                    {
                        t = new Texture(OnDevice, 320, 240, 1, Usage.None, Format.A32B32G32R32F, Pool.Default);
                    }
                    else
                    {
