    ...
    {	          	
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	...
	        	Info.Name = "IOSnuffler";					    //use CamelCaps and no spaces
	        	Info.Category = "Phidgets";						//try to use an existing one
	        	Info.Version = "Manager";						//versions are optional. leave blank if not needed
	        	Info.Help = "";
	        	Info.Bugs = "";
	        	Info.Credits = "www.phidgets.com";				//give credits to thirdparty code used
	        	Info.Warnings = "";
