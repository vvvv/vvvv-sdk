    ...
    public class SetLevelMatrixNode : IPlugin
    {
        ...
        public static IPluginInfo PluginInfo 
        {
            get
            {
                ...
                Info.Category = "Bass";
                Info.Version = "";
                Info.Help = "Set Mixer levelfor Bass";
                Info.Bugs = "";
                Info.Credits = "";
                Info.Warnings = "";
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            if (this.FPinInLevel.PinIsChanged || updatelevel)
            {
                UpdateMatrix();
            }
        }
        ...
        private void UpdateMatrix()
        {
            ...
            ChannelInfo info = ChannelsManager.GetChannel(Convert.ToInt32(dhandle));
            int mixerhandle = 0;
            ...
            if (mixerhandle != 0)
            {
                this.FMixerInfo = Bass.BASS_ChannelGetInfo(mixerhandle);
                this.FChannelInfo = Bass.BASS_ChannelGetInfo(info.BassHandle.Value);
