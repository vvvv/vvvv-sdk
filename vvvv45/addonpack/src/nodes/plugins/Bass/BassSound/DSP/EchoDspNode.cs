...
{
    public class EchoDspNode : AbstractDSPNode<BASS_BFX_ECHO>,IPlugin
    {
        ...
        {
            get { return BASSFXType.BASS_FX_BFX_ECHO; }
        }
        #endregion
        ...
        protected override void OnPluginHostSet()
        {
            ...
            this.FPinInDelay.SetSubType(1200, 30000, 1, 1200, false, false, true);

            this.FDsp = new BASS_BFX_ECHO();
        }
        #endregion
