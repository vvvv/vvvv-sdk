...
namespace VVVV.Nodes
{
    ...
    {	          	
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	//create outputs	    	
	    	FHost.CreateValueOutput("BatteryPower", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FMyValueOutput);
	    	FMyValueOutput.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
	    	
	    	FHost.CreateStringOutput("PowerMode", TSliceMode.Dynamic, TPinVisibility.True, out FMyStringOutput);
