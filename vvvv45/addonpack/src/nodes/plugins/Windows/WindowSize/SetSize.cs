...
{
    #region PluginInfo
    [PluginInfo(Name = "SetSize", Category = "Windows", Version="Client", Help = "Sets the size of the window.", Tags = "resize, dimensions, resolution", AutoEvaluate = true)]
    #endregion PluginInfo
    public class SetSize : IPluginEvaluate
    {
        #region fields & pins
