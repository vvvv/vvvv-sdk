...
{
    public abstract class AbstractUpdateNode<T, D> : IPlugin, IPluginConnections
        ...
        where D : IDbConnection
    {
        ...
        public void SetPluginHost(IPluginHost Host)
        {
            ...
            this.FHost.CreateStringInput("Set", TSliceMode.Single, TPinVisibility.True, out this.FPinInSet);
            this.FPinInSet.SetSubType("", false);
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            if (this.FPinInTable.PinIsChanged ||
                this.FPinInSet.PinIsChanged ||
                this.FPinInWhere.PinIsChanged)
            {
                string table, set, where;
                this.FPinInTable.GetString(0, out table);
                this.FPinInSet.GetString(0, out set);
