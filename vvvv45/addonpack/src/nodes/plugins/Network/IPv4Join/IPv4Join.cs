...
namespace VVVV.Nodes
{
	...
	//class definition
	public class IPv4Join: IPlugin, IDisposable
    {	          	
    	...
    	private IValueIn FMyValueInputA;
        private IValueIn FMyValueInputB;
        private IValueIn FMyValueInputC;
        private IValueIn FMyValueInputD;
