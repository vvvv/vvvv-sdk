...
namespace VVVV.Nodes.Http
{
    ...
    /// </summary>
    public class RendererHTTPSocket : IPlugin, IDisposable, IPluginConnections
    {
        ...
        /// </summary>
        public RendererHTTPSocket()
        {
            FServer = new VVVV.Webinterface.HttpServer.Server(mPortNumber, mBacklog);
        }
        ...
        public static IPluginInfo PluginInfo
        {
            get
            {
                ...
                Info.Version = "Async Socket";						//versions are optional. leave blank if not needed
                Info.Help = "";
                Info.Bugs = "";
