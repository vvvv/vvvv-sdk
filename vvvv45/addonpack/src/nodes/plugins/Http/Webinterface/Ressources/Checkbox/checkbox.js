...
(function($){
	...
	$.fn.checkbox = function(options) {
		...
		return this.each(function()
		{
			...
			ch.wrapper = $('<div class="' + settings.cls + '"><div class="mark"><img src="' + settings.empty + '" /></div></div>');
			...
			ch.wrapper.css({position: 'absolute' , top: ttop, left: tleft, width: twidth, height: theight });
