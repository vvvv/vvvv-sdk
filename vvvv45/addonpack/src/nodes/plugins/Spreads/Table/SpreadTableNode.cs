...
namespace VVVV.Nodes.Table
{
	...
	#region PluginInfo
	[PluginInfo(Name = "Table", Category = "Spreads", Help = "Create an instance of a Table to be used elsewhere", Tags = "store, persistent, save, load", Author = "elliotwoods", AutoEvaluate = true)]
