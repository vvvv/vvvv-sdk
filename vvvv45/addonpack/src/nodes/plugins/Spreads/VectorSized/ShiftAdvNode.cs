...
namespace VVVV.Nodes
{
	...
	//class definition
	public class ShiftAdvNode: IPlugin, IDisposable
    {	          	
        ...
        protected virtual void Dispose(bool disposing)
        {
        	...
        	if(!FDisposed)
        	{
        		...
        		FHost.Log(TLogType.Debug, "ShiftAdvNode is being deleted");
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Help = "Shift (Spreads) with bin and vector size";
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	FHost.CreateValueInput("Toggle Phase/Slicecount", 1, null, TSliceMode.Dynamic, TPinVisibility.Hidden, out FTogPhase);
	    	FTogPhase.SetSubType(0, 1, 1, 0, false, true, false);
	    	
	    	FHost.CreateValueInput("Phase", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FPhase);
	    	FPhase.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.0, false, false, false);
        ...
        {     	
        	...
        	if (FInput.PinIsChanged || FVecSize.PinIsChanged || FBinSize.PinIsChanged || FPhase.PinIsChanged)
        	{	
	        	double tmpVec;
	        	...
	        	{
	        		double curPhase;
	        		FPhase.GetValue(i, out curPhase);
	        		
	        		int vecCount = spread.GetBin(i).Count/vecSize;
	        		int phase = (int)Math.Round(curPhase*vecCount);
	        		double curTog;
	        		FTogPhase.GetValue(i, out curTog);
	        		if (curTog>0.5)
	        			phase = (int)(curPhase%vecCount);
	        		for (int j=0; j<vecCount; j++)
	        		{
	        			outList.AddRange(spread.GetBinVector(i,j-phase));
	        		}
	        	}
