...
namespace VVVV.Nodes
{
	...
	//class definition
	public class DiffAdvNode: IPlugin, IDisposable
    {	          	
        ...
        protected virtual void Dispose(bool disposing)
        {
        	...
        	if(!FDisposed)
        	{
        		...
        		FHost.Log(TLogType.Debug, "DiffAdvNode is being deleted");
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Help = "Differential (Spreads) with bin and vector size";
        ...
        {     	
        	...
        	{	
	        	...
	        	for (int i=0; i<spread.BinCount; i++)
	        	{
	        		...
	        		for (int j=0; j<(curBin.Count/vecSize)-1; j++)
	        		{
