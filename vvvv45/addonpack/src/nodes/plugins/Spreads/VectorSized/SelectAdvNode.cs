...
namespace VVVV.Nodes
{
	...
	//class definition
	public class SelectAdvNode: IPlugin, IDisposable
    {	          	
    	...
    	private IValueIn FSelect;
    	
    	//output pin declaration
    	private IValueOut FOut;
    	private IValueOut FFormerId;
    	
    	#endregion field declaration
       
    	#region constructor/destructor
    	
        public SelectAdvNode()
        {
        ...
        protected virtual void Dispose(bool disposing)
        {
        	...
        	if(!FDisposed)
        	{
        		...
        		FHost.Log(TLogType.Debug, "SelectAdvNode is being deleted");
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Help = "Select (Value) with bin and vector size";
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	FHost.CreateValueInput("Select", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FSelect);
	    	FSelect.SetSubType(0, double.MaxValue, 1, 1, false, false, true);
	    	...
	    	FHost.CreateValueOutput("Former Slice", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FFormerId);
	    	FFormerId.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
        ...
        {     	
        	...
        	if (FInput.PinIsChanged || FVecSize.PinIsChanged || FBinSize.PinIsChanged || FSelect.PinIsChanged)
        	{	
	        	double tmpVec;
	        	...
	        	List<double> fId = new List<double>();
	        	...
	        	for (int i=0; i<spread.BinCount; i++)
	        	{
	        		...
	        		FSelect.GetValue(i, out tmpSelect);
	        		int select = (int)Math.Round(tmpSelect);
	        		...
	        		if (select>0)
	        		{
	        			...
	        			{
	        				outSpread.AddRange(curBin);
	        				for (int id=0; id<curBin.Count/vecSize; id++)
	        				{
	        					fId.Add(incr+id);
	        				}
	        			}
	        		}
	        		incr+=curBin.Count/vecSize;
	        	}
	        	...
	        	FFormerId.SliceCount=fId.Count;
	        	for (int i=0; i<fId.Count; i++)
	        	{
	        		FFormerId.SetValue(i, fId[i]);
	        	}
        	}      	
        }
