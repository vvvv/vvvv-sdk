...
namespace VVVV.Nodes
{
	...
	//class definition
	public class ReverseAdvNode: IPlugin, IDisposable
    {	          	
        ...
        protected virtual void Dispose(bool disposing)
        {
        	...
        	if(!FDisposed)
        	{
        		...
        		FHost.Log(TLogType.Debug, "ReverseAdvNode is being deleted");
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Help = "Reverse (Spreads) with bin and vector size";
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	FHost.CreateValueInput("Reverse", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FDo);
        ...
        {     	
        	...
        	{			        	
	        	...
	        	{
	        		double doRev;
	        		FDo.GetValue(i, out doRev);
	        		if (doRev>0.5)
	        		{
	        			for (int j=(spread.GetBin(i).Count/vecSize)-1; j>=0; j--)
	        			{
	        		...
	        		{
	        			outList.AddRange(spread.GetBin(i));
	        		}
	        	}
