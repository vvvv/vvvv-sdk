...
namespace VVVV.Nodes
{
	...
	//class definition
	public class CDRAdvNode: IPlugin, IDisposable
    {	          	
    	...
    	private IValueOut FRest;
    	private IValueOut FLast;
        ...
        protected virtual void Dispose(bool disposing)
        {
        	...
        	if(!FDisposed)
        	{
        		...
        		FHost.Log(TLogType.Debug, "CDRAdvNode is being deleted");
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Help = "CDR (Spreads) with bin and vector size";
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	//create outputs	    	
	    	FHost.CreateValueOutput("Remainder", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FRest);
	    	FRest.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
	    	
	    	FHost.CreateValueOutput("Last Slice", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FLast);
	    	FLast.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
        ...
        {     	
        	...
        	{	
	        	...
	        	{
	        		for (int j=0; j<(spread.GetBin(i).Count/vecSize)-1; j++)
	        		{
	        			rest.AddRange(spread.GetBinVector(i,j));
	        		}
	        		last.AddRange(spread.GetBinVector(i,(spread.GetBin(i).Count/vecSize)-1));
	        	}
        		
	        	FRest.SliceCount=rest.Count;
	        	for (int i=0; i<rest.Count; i++)
	        	{
	        		FRest.SetValue(i, rest[i]);
	        	}
	        	
	        	FLast.SliceCount=last.Count;
	        	for (int i=0; i<last.Count; i++)
	        	{
	        		FLast.SetValue(i, last[i]);
	        	}
        	}      	
        }
