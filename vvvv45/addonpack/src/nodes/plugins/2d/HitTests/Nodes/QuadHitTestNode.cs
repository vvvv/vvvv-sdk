...
{
    public class QuadHitTestNode : Abstract2dhitTestNode, IPlugin
    {
        #region Plugin Info
        public static IPluginInfo PluginInfo
        {
            get
            {
                ...
                Info.Version = "Quad";						//versions are optional. leave blank if not needed
                Info.Help = "Performs a Hittest between a set of points and quad shapes";
                Info.Bugs = "";
