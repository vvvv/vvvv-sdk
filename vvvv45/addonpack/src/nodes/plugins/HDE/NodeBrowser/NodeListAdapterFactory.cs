...
{
	public class NodeListAdapterFactory: IAdapterFactory
	{
		...
		public NodeListAdapterFactory()
		{
			...
			knownMappings.Add(typeof(AlphabetModel), typeof(NodeListModelContentProvider));
			knownMappings.Add(typeof(CategoryModel), typeof(NodeListModelContentProvider));
			knownMappings.Add(typeof(CategoryEntry), typeof(CategoryEntryContentProvider));
			knownMappings.Add(typeof(NodeInfoDummy), typeof(NodeInfoContentProvider));
