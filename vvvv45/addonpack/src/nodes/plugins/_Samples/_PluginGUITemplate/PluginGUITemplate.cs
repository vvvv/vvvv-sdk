	...
	public class GUITemplatePlugin: UserControl, IPlugin
    {
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	...
	        	Info.Version = "GUI";							//versions are optional. leave blank if not needed
	        	Info.Help = "Offers a basic code layout to start from when writing a vvvv plugin with GUI";
	        	Info.Bugs = "";
