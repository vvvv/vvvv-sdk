...
namespace VVVV.Nodes
{
    ...
    //class definition
    public class RösslerAttractor : IPlugin, IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!FDisposed)
            {
                ...
                FHost.Log(TLogType.Debug, "RösslerAttractor is being deleted");
        ...
        public static IPluginInfo PluginInfo
        {
            get
            {
                if (FPluginInfo == null)
                {
                    ...
                    FPluginInfo.Name = "RösslerAttractor";
                    ...
                    FPluginInfo.Help = "Rössler system's attractor";
                    //specify a comma separated list of tags that describe the node
                    FPluginInfo.Tags = "chaos,attractor";
        ...
        public void SetPluginHost(IPluginHost Host)
        {
            ...
            FValueInputX.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
            ...
            FValueInputY.SetSubType(double.MinValue, double.MaxValue, 0.01, 0, false, false, false);
            ...
            FValueInputA.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.2, false, false, false);

            FHost.CreateValueInput("B", 1, null, TSliceMode.Single, TPinVisibility.True, out FValueInputC);
            FValueInputC.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.2, false, false, false);

            FHost.CreateValueInput("C", 1, null, TSliceMode.Single, TPinVisibility.True, out FValueInputB);
            FValueInputB.SetSubType(double.MinValue, double.MaxValue, 0.01, 5.7, false, false, false);
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            if (FValueInputB.PinIsChanged)
                FValueInputB.GetValue(0, out C);

            if (FValueInputC.PinIsChanged)
                FValueInputC.GetValue(0, out B);
            ...
            {
                //compute Rössler map
                currentValueSliceV1 = - previousValueSliceY[i] - previousValueSliceZ[i];
                currentValueSliceV2 = previousValueSliceX[i] + A * previousValueSliceY[i];
                currentValueSliceV3 = B + previousValueSliceZ[i] * (previousValueSliceX[i] - C);
