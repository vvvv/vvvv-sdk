...
namespace VVVV.Nodes
{
    ...
    //class definition
    public class TinkerBell : IPlugin, IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!FDisposed)
            {
                ...
                FHost.Log(TLogType.Debug, "TinkerBell is being deleted");
        ...
        public static IPluginInfo PluginInfo
        {
            get
            {
                if (FPluginInfo == null)
                {
                    ...
                    FPluginInfo.Help = "discrete time dynamical system";
        ...
        public void SetPluginHost(IPluginHost Host)
        {
            ...
            FValueInputA.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.9, false, false, false);

            FHost.CreateValueInput("B", 1, null, TSliceMode.Single, TPinVisibility.True, out FValueInputB);
            FValueInputB.SetSubType(double.MinValue, double.MaxValue, 0.01, -0.6013, false, false, false);

            FHost.CreateValueInput("C", 1, null, TSliceMode.Single, TPinVisibility.True, out FValueInputC);
            FValueInputC.SetSubType(double.MinValue, double.MaxValue, 0.01, 2, false, false, false);

            FHost.CreateValueInput("D", 1, null, TSliceMode.Single, TPinVisibility.True, out FValueInputD);
            FValueInputD.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.5, false, false, false);
        ...
        public void Evaluate(int SpreadMax)
        {
            ...
            for (int i = 0; i < SpreadMax; i++)
            {
                ...
                currentValueSliceV1 = previousValueSliceX[i] * previousValueSliceX[i] - previousValueSliceY[i] * previousValueSliceY[i] + A * previousValueSliceX[i] + B * previousValueSliceY[i];
                currentValueSliceV2 = previousValueSliceX[i] * previousValueSliceY[i] + C * previousValueSliceX[i] + D * previousValueSliceY[i];
