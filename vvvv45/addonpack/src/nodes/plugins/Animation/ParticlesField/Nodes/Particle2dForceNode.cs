...
namespace VVVV.Nodes
{
    ...
    public unsafe class Particle2dForceNode : IPlugin, IDisposable
    {
        #region Plugin Info
        public static IPluginInfo PluginInfo
        {
            get
            {
                ...
                Info.Version = "ForceField";						//versions are optional. leave blank if not needed
        ...
        private IValueIn FPinInVelocity;
        private IValueIn FpinInDamping;
        ...
        private ParticleForceSystem FParticleSystem = new ParticleForceSystem();
        #endregion
        ...
        public void SetPluginHost(IPluginHost Host)
        {
            ...
            this.FHost.CreateValueInput("Velocity", 2, null , TSliceMode.Dynamic, TPinVisibility.True, out this.FPinInVelocity);
            this.FPinInVelocity.SetSubType2D(double.MinValue, double.MaxValue, 0.01, 0, 0, false, false, false);

            this.FHost.CreateValueInput("Damping", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out this.FpinInDamping);
            this.FpinInDamping.SetSubType(0, double.MaxValue, 0.01, 0, false, false, false);
