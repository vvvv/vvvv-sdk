...
namespace VVVV.Nodes
{
	...
	//class definition
	public class StereographicProjection: IPlugin, IDisposable
    {	          	
        ...
        public static IPluginInfo PluginInfo
	    {
	        get 
	        {
	        	if (FPluginInfo == null)
				{
					...
					FPluginInfo.Name = "StereographicProjection";
					...
					FPluginInfo.Help = "Maps the XY plane into the unit sphere";
        ...
        public void SetPluginHost(IPluginHost Host)
	    {
	    	...
	    	//create inputs
            FHost.CreateValueInput("Input X", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FMyValueInputX);
            FMyValueInputX.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.5, false, false, false);
            
            FHost.CreateValueInput("Input Y", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FMyValueInputY);
            FMyValueInputX.SetSubType(double.MinValue, double.MaxValue, 0.01, 0.5, false, false, false);
            ...
            FHost.CreateValueOutput("Output Z", 1, null, TSliceMode.Dynamic, TPinVisibility.True, out FMyValueOutputZ);
