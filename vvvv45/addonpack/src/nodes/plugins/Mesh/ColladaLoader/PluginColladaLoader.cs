...
namespace VVVV.Nodes
{
    ...
    public class PluginColladaLoader: IPluginEvaluate, IDisposable
    {
            ...
            IDiffSpread<double> FMeterTargetConfig)
        {
            ...
            FCsSourceTypeConfig.Changed += new SpreadChangedEventHander<CoordinateSystemType>(FCsSourceTypeConfig_Changed);
            FUpAxisSourceConfig.Changed += new SpreadChangedEventHander<Axis>(FUpAxisSourceConfig_Changed);
            FRightAxisSourceConfig.Changed += new SpreadChangedEventHander<Axis>(FRightAxisSourceConfig_Changed);
            FMeterSourceConfig.Changed += new SpreadChangedEventHander<double>(FMeterSourceConfig_Changed);
            FCsTargetTypeConfig.Changed += new SpreadChangedEventHander<CoordinateSystemType>(FCsTargetTypeConfig_Changed);
            FUpAxisTargetConfig.Changed += new SpreadChangedEventHander<Axis>(FUpAxisTargetConfig_Changed);
            FRightAxisTargetConfig.Changed += new SpreadChangedEventHander<Axis>(FRightAxisTargetConfig_Changed);
