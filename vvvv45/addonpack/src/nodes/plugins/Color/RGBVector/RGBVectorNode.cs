...
{
	#region PluginInfo
	[PluginInfo(Name = "RGB", Category = "Color", Version = "Split Vector", Help = "splits a color in a vector with red, green, blue and alpha components", Tags = "")]
...
//			Memory.Copy(outData, inData, (uint)(inCount*4*sizeof(double)));
		...
		#region PluginInfo
		[PluginInfo(Name = "RGB", Category = "Color", Version = "Join Vector", Help = "creates a colour out of the red, green, blue and alpha components of a vector", Tags = "")]
		#endregion PluginInfo
		public unsafe class RGBVectorJoinNode : IPluginEvaluate
		{
			#region fields & pins
			[Input("", Dimension = 4, DefaultValues = new double[]{0,1,0,1})]
			IValueFastIn FInPin;
