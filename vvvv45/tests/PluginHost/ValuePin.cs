...
namespace Hoster
{
    ...
    {
        private readonly UnmanagedArray FValues;
        ...
        override public void SetSpreadAsString(string Spread)
        {
            ...
            else
            {
                ...
                SliceCount = (int) slices.Length / FDimension; 
        ...
        unsafe public void GetValuePointer(out int* length, out double** dataPointer)
        {
            length = FValues.PLength;
            dataPointer = FValues.PPData;
        }
        
        unsafe public void GetValuePointer(out double** Value)
        {
            Value = FValues.PPData;
        }
    }
}
